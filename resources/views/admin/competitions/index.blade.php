        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/competitions/create') }}" class="btn btn-success btn-sm" title="Add New Competition">
                            ...
                            <table class="table">
                                ...
                                @foreach($competitions as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/competitions/' . $item->id) }}" title="View Competition"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/competitions/' . $item->id . '/edit') }}" title="Edit Competition"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
